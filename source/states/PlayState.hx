...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'greenday': new states.stages.GreenDay(); //Week AXS #1
			case 'greenvecher': new states.stages.GreenVecher(); //Week AXS #2
			case 'greennight': new states.stages.GreenNight(); //Week AXS #3
		}
	...
	{
		if(startedCountdown) {
			//case 'baka' | 'broadcasting' | 'my sweet':
