...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['BPS Team'],
			['Red Leader',			'redleader',		'Main Director Mod',											'https://www.youtube.com/@AxS_94',								'CF2D2D'],
			['Votex',				'votex',			"Main Programmer mod and Make cover's",							'https://www.youtube.com/channel/UC9xb0IjXkBTGlmh2Z1JYB4g',		'444444'],
			['YouSha',				'flower',			"Main Atrist mod",												'https://www.youtube.com/channel/UC9xb0IjXkBTGlmh2Z1JYB4g',		'E1843A'],
			['Fervit',				'fervit',			"Idk, member of this mod",										'https://youtube.com/@ferenalforteavalar?si=HoGDUT4xeCr_HIfu',	'483D92'],
			['Special Thanks'],
			['Jeferat',			'jeferat',			'Tester \nAnd recording Mod Gameplay #1',							'https://www.youtube.com/@_JeFeRaT_',				'5ABD4B'],
			['Psych Engine Team'],
